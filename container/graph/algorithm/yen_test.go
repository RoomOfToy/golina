...
func TestYenKSP(t *testing.T) {
	...
	expectedDistPath := map[float64][]graph.ID{
		5: []graph.ID{graph.StringID("C"), graph.StringID("E"), graph.StringID("F"), graph.StringID("H")},
		7: []graph.ID{graph.StringID("C"), graph.StringID("E"), graph.StringID("G"), graph.StringID("H")},
		8: []graph.ID{graph.StringID("C"), graph.StringID("D"), graph.StringID("F"), graph.StringID("H")},
	}
